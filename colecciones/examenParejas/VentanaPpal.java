...
public class VentanaPpal extends JFrame {
	...
	public VentanaPpal(Principal controlador) {
		...
		gl_panel.setHorizontalGroup(gl_panel.createParallelGroup(Alignment.LEADING).addGroup(gl_panel
				...
				.addGroup(gl_panel.createParallelGroup(Alignment.LEADING).addGroup(gl_panel.createSequentialGroup()
						...
						.addGap(10).addComponent(botonAltaSolicitante, GroupLayout.DEFAULT_SIZE, 217, Short.MAX_VALUE))
						.addGroup(gl_panel.createParallelGroup(Alignment.LEADING, false)
								.addGroup(gl_panel.createSequentialGroup()
										.addComponent(lblNombre, GroupLayout.PREFERRED_SIZE, 57,
												GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(ComponentPlacement.RELATED)
										.addComponent(campoNombreAlta, GroupLayout.DEFAULT_SIZE, 422, Short.MAX_VALUE))
								.addGroup(gl_panel.createSequentialGroup()
										.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
												.addComponent(radioSexoSolicitanteMujer, GroupLayout.PREFERRED_SIZE, 63,
														GroupLayout.PREFERRED_SIZE)
												.addComponent(radioSexoSolicitanteHombre)
												.addComponent(lblSexo, GroupLayout.PREFERRED_SIZE, 107,
														GroupLayout.PREFERRED_SIZE))
										.addGap(44)
										.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
												.addComponent(radioSexoParejaSolicitadaHombre,
														GroupLayout.PREFERRED_SIZE, 63, GroupLayout.PREFERRED_SIZE)
												.addGroup(gl_panel.createSequentialGroup().addComponent(lblSexoDeLa)
														.addGap(43).addComponent(checkGestor))
		...
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(Alignment.LEADING).addGroup(gl_panel
				.createSequentialGroup().addContainerGap()
				.addGroup(gl_panel
						.createParallelGroup(Alignment.BASELINE).addComponent(lblNombre).addComponent(campoNombreAlta,
								GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addGap(18)
				.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel.createSequentialGroup().addComponent(lblSexo)
								.addPreferredGap(ComponentPlacement.RELATED).addComponent(radioSexoSolicitanteHombre)
								.addPreferredGap(ComponentPlacement.RELATED).addComponent(radioSexoSolicitanteMujer))
				...
				.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_panel.createSequentialGroup().addGap(18).addComponent(lblGustosYAficiones)
								.addPreferredGap(ComponentPlacement.RELATED)
		...
		listaAficiones.setModel(new AbstractListModel<String>() {
			private static final long serialVersionUID = 1L;
			String[] values = new String[] { "Leer", "Ver la tele", "Pasar tiempo con la familia", "Ir al cine",
					"Pescar", "Pasar el tiempo en el PC o port\u00E1til", "Dedicarse a la jardiner\u00EDa",
					"Alquilar pel\u00EDculas", "Pasear", "Hacer ejercicio", "Escuchar m\u00FAsica",
					"Realizar peque\u00F1as tareas divertidas", "Ir de caza", "Practicar deportes en equipo",
					"Ir de compras", "Viajar", "Dormir", "Socializarse", "Coser", "Jugar al golf",
					"Actividades de iglesia", "Relajarse", "Tocar alg\u00FAn instrumento", "Hacer las tareas del hogar",
					"Artesan\u00EDa", "Ver partidos", "Montar en bici", "Jugar a las cartas", "Excursionismo",
					"Cocinar", "Ir a cenar fuera", "Tener citas online", "Nadar", "Ir de camping", "Esquiar",
					"Arreglar coches", "Montar en barco", "Escribir", "Ir en motocicleta", "Cuidado de animales",
					"Jugar a los bolos", "Pintar", "Ir a correr", "Bailar", "Montar a caballo", "Jugar al tennis",
					"Ir al teatro", "Jugar al billar", "Ir a la playa", "Trabajar como voluntario" };
				...
				.addGroup(gl_panel_1.createSequentialGroup().addContainerGap().addGroup(gl_panel_1
						...
						.addGroup(Alignment.LEADING,
								gl_panel_1.createSequentialGroup()
										.addComponent(lblPrimerSolicitante, GroupLayout.PREFERRED_SIZE, 81,
												GroupLayout.PREFERRED_SIZE)
										.addGap(57).addComponent(comboSolicitante, 0, 345, Short.MAX_VALUE))
						.addGroup(Alignment.LEADING,
								gl_panel_1.createSequentialGroup()
										.addComponent(lblGestorDeParejas, GroupLayout.PREFERRED_SIZE, 134,
												GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(ComponentPlacement.RELATED)
										.addComponent(comboGestor, 0, 345, Short.MAX_VALUE))
						.addGroup(Alignment.LEADING,
								gl_panel_1.createSequentialGroup().addComponent(lblParejaSeleccionada).addGap(39)
										.addComponent(comboPareja, 0, 345, Short.MAX_VALUE))
						.addGroup(Alignment.LEADING, gl_panel_1.createSequentialGroup()
								.addComponent(botonMostrarAfinidades, GroupLayout.PREFERRED_SIZE, 243,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.RELATED)
		...
		gl_panel_1.setVerticalGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_1.createSequentialGroup().addContainerGap()
						.addGroup(gl_panel_1.createParallelGroup(Alignment.BASELINE).addComponent(lblGestorDeParejas)
								.addComponent(comboGestor, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addGap(18)
						.addGroup(gl_panel_1.createParallelGroup(Alignment.BASELINE).addComponent(lblPrimerSolicitante)
								.addComponent(comboSolicitante, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addGap(18)
						.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
								.addComponent(comboPareja, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addGroup(gl_panel_1
										.createSequentialGroup().addGap(4).addComponent(lblParejaSeleccionada)))
						.addGap(18)
						.addGroup(gl_panel_1.createParallelGroup(Alignment.BASELINE)
								.addComponent(botonMostrarAfinidades).addComponent(botonCrearPareja))
						.addPreferredGap(ComponentPlacement.UNRELATED)
						.addComponent(scrollPane_1, GroupLayout.DEFAULT_SIZE, 148, Short.MAX_VALUE).addContainerGap()));
		...
		botonListarParejasPorGestor
				.setToolTipText("Listado ordenado por nombre de gestor, con las parejas hechas por cada uno");
		...
		gl_panel_2.setHorizontalGroup(gl_panel_2.createParallelGroup(Alignment.LEADING).addGroup(gl_panel_2
				...
				.addGroup(gl_panel_2.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panel_2.createSequentialGroup().addComponent(botonListarTodo)
								.addPreferredGap(ComponentPlacement.RELATED).addComponent(botonListarParejasPorGestor)))
				.addContainerGap()));
		gl_panel_2.setVerticalGroup(gl_panel_2.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_2.createSequentialGroup().addContainerGap()
						.addGroup(gl_panel_2.createParallelGroup(Alignment.BASELINE).addComponent(botonListarTodo)
								.addComponent(botonListarParejasPorGestor))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(scrollPane_2, GroupLayout.DEFAULT_SIZE, 273, Short.MAX_VALUE).addContainerGap()));
	...
	protected void botonAltaSolicitantePulsado() {
		...
		else if (this.listaAficiones.isSelectionEmpty())
			this.error("Seleccione al menos una afici�n.");
		else if (this.controlador.altaSolicitante(this.campoNombreAlta.getText(),
				...
				this.checkGestor.isSelected(), this.listaAficiones.getSelectedValuesList()) == Modelo.YA_EXISTE)
	...
	protected void botonMostrarAfinidadesPulsado() {
		if (this.comboSolicitante.getSelectedIndex() < 1)
			...
			this.areaTexto
					.setText(this.controlador.getListadoAfinidades((String) this.comboSolicitante.getSelectedItem()));
	}

	protected void botonCrearParejaPulsado() {
		if (this.comboGestor.getSelectedIndex() < 1)
			this.error("Debe seleccionar alg�n gestor.");
		else if (this.comboSolicitante.getSelectedIndex() < 1)
			this.error("Debe seleccionar alg�n solicitante.");
		else if (this.comboPareja.getSelectedIndex() < 1)
			this.error("Debe seleccionar alguna pareja.");
		else if (((String) this.comboSolicitante.getSelectedItem()).equals((String) this.comboPareja.getSelectedItem()))
			this.error("La pareja no puede ser el mismo solicitante.");
		else if (this.controlador.creaPareja((String) this.comboGestor.getSelectedItem(),
				(String) this.comboSolicitante.getSelectedItem(),
				(String) this.comboPareja.getSelectedItem()) == Modelo.YA_EXISTE)
