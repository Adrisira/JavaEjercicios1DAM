...
public class Principal {
	...
	public int altaSolicitante(String nombre, Sexo sexoSolicitante, Sexo sexoSolicitado, boolean gestor,
			List<String> aficiones) {
		return this.modelo.anyadeSolicitante(nombre, sexoSolicitante, sexoSolicitado, gestor, aficiones);
	}
