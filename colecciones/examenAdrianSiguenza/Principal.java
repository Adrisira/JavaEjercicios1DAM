...
public class Principal {
	...
	public static void main(String[] args) {
		...
		// creaci�n de todos los monstruos
		...
		//Creo partidas y las a�ado al modelo
		...
		//a�adimos algunos monstruos de cada jugador a una partida
		...
		//en la partida 4 aun no se han a�adido monstruos porque acaba de empezar.
		...
		System.out.println(p1.getMostruosJugadoresEnPartida());
		System.out.println(p2.getMostruosJugadoresEnPartida());
		System.out.println(p3.getMostruosJugadoresEnPartida());
		System.out.println(p4.getMostruosJugadoresEnPartida());
		System.out.println(p5.getMostruosJugadoresEnPartida());*/
		
		System.out.println("--------------");
		System.out.println("a) Monstruo disponible para m�s jugadores (debe salir electricat): "+modelo.getMonstruoDisponibleMasJugadores());
		...
		System.out.println("--------------");
		System.out.println("c) Jugadores y su n�mero de partidas ganadas: "+modelo.numPartidasGanador());
		...
		System.out.println("e) Monstruos de jArgoMejor antes de ataque en partida p1 (ver puntos salud werewolf 1035): "+ p1.getMostruosJugadoresEnPartida().get(0));
		
		p1.atacar(jErMaster, unbereable, werewolf); //1035 - 420 = 615
		System.out.println("e) Monstruos de jArgoMejor tras primer ataque en partida p1 (ver puntos salud werewolf 615): "+ p1.getMostruosJugadoresEnPartida().get(0));
		
		p1.atacar(jErMaster, unbereable, werewolf); //615 - 420 = 195
		System.out.println("e) Monstruos de jArgoMejor tras segundo ataque en partida p1 (ver puntos salud werewolf 195): "+ p1.getMostruosJugadoresEnPartida().get(0));
		...
		System.out.println("e) Monstruos de jArgoMejor tras tercer ataque en partida p1 (ver puntos salud werewolf -225): "+ p1.getMostruosJugadoresEnPartida().get(0));
		System.out.println("e) Puntos tras morir werewolf en partida p1 (jErMaster -jugador en posici�n 1- debe tener uno m�s): "+ p1.getPuntosJugadores());
