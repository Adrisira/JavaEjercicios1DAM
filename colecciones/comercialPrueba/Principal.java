...
public class Principal
{
	...
	private void anadeDatosDePrueba()
	{
	
		this.modelo.anadeComercial(c1);
		this.modelo.anadeComercial(c2);
		this.modelo.anadeComercial(c3);
		this.modelo.anadeComercial(c4);
		this.modelo.anadeComercial(c5);
		this.modelo.anadeComercial(c6);
		this.modelo.anadeComercial(c7);
		this.modelo.anadeComercial(c8);
		this.modelo.anadeComercial(c9);
...
c9  1  0  0  0  0  0  1  0  1
		...
		*/
		...
		this.modelo.anadeVisita(new Visita(c1,e4,3));
		this.modelo.anadeVisita(new Visita(c8,e3,5));
		this.modelo.anadeVisita(new Visita(c6,e3,3));
		this.modelo.anadeVisita(new Visita(c8,e3,5));
		this.modelo.anadeVisita(new Visita(c5,e5,7));
		this.modelo.anadeVisita(new Visita(c7,e2,8));
		this.modelo.anadeVisita(new Visita(c2,e3,3));
		this.modelo.anadeVisita(new Visita(c2,e4,3));
	}
