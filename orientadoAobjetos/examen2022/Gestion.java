...
public static void main(String[] args) {
		...
		System.out.println("\nApartado e)");
		System.out.println("Rutas ordenadas por kilómetros:"+listaRutas.getListaOrdenada()); 
		
		//Prueba Ciudad Gastronomica
		System.out.println("\nApartado f)");

		CiudadGastronomica malaga = new CiudadGastronomica("Malaga", 1000,new String [] {"Cocido", "Tomate"});
